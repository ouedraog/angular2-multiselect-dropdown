(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/
    function Bsz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function qtn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(VirtualScrollerComponent, [{
          ...
          value: function scrollToIndex(index) {
            ...
            var retryIfNeeded = function retryIfNeeded() {
              ...
              var dimensions = _this3.calculateDimensions();

              var desiredStartIndex = Math.min(Math.max(index, 0), dimensions.itemCount - 1);

              if (_this3.previousViewPort.startIndex === desiredStartIndex) {
                if (animationCompletedCallback) {
                  animationCompletedCallback();
                }
              ...
              _this3.scrollToIndex_internal(index, alignToBeginning, additionalOffset, 0, retryIfNeeded);
            };
          ...
          value: function scrollToPosition(scrollPosition) {
            ...
            var newTween = new _tweenjs_tween_js__WEBPACK_IMPORTED_MODULE_3__["Tween"](tweenConfigObj).to({
              ...
              _this4.renderer.setProperty(scrollElement, _this4._scrollType, data.scrollPosition);

              _this4.refresh_internal(false);
            }).onStop(function () {
            ...
            var animate = function animate(time) {
              ...
              if (tweenConfigObj.scrollPosition === scrollPosition) {
                _this4.refresh_internal(false, animationCompletedCallback);
          ...
          value: function refresh_internal(itemsArrayModified) {
            ...
            if (itemsArrayModified && this.previousViewPort && this.previousViewPort.scrollStartPosition > 0) {
              ...
              refreshCompletedCallback = function refreshCompletedCallback() {
                var scrollLengthDelta = _this5.previousViewPort.scrollLength - oldViewPort.scrollLength;

                if (scrollLengthDelta > 0 && _this5.viewPortItems) {
                  var oldStartItem = oldViewPortItems[0];

                  var oldStartItemIndex = _this5.items.findIndex(function (x) {
                    return _this5.compareItems(oldStartItem, x);
                  });

                  if (oldStartItemIndex > _this5.previousViewPort.startIndexWithBuffer) {
                    var itemOrderChanged = false;

                    for (var i = 1; i < _this5.viewPortItems.length; ++i) {
                      if (!_this5.compareItems(_this5.items[oldStartItemIndex + i], oldViewPortItems[i])) {
                    ...
                    if (!itemOrderChanged) {
                      _this5.scrollToPosition(_this5.previousViewPort.scrollStartPosition + scrollLengthDelta, 0, oldRefreshCompletedCallback);
            ...
            this.zone.runOutsideAngular(function () {
              requestAnimationFrame(function () {
                if (itemsArrayModified) {
                  _this5.resetWrapGroupDimensions();
                }

                var viewport = _this5.calculateViewport();

                var startChanged = itemsArrayModified || viewport.startIndex !== _this5.previousViewPort.startIndex;
                var endChanged = itemsArrayModified || viewport.endIndex !== _this5.previousViewPort.endIndex;
                var scrollLengthChanged = viewport.scrollLength !== _this5.previousViewPort.scrollLength;
                var paddingChanged = viewport.padding !== _this5.previousViewPort.padding;
                var scrollPositionChanged = viewport.scrollStartPosition !== _this5.previousViewPort.scrollStartPosition || viewport.scrollEndPosition !== _this5.previousViewPort.scrollEndPosition || viewport.maxScrollPosition !== _this5.previousViewPort.maxScrollPosition;
                _this5.previousViewPort = viewport;

                if (scrollLengthChanged) {
                  _this5.renderer.setStyle(_this5.invisiblePaddingElementRef.nativeElement, _this5._invisiblePaddingProperty, "".concat(viewport.scrollLength, "px"));
                }

                if (paddingChanged) {
                  if (_this5.useMarginInsteadOfTranslate) {
                    _this5.renderer.setStyle(_this5.contentElementRef.nativeElement, _this5._marginDir, "".concat(viewport.padding, "px"));
                  } else {
                    _this5.renderer.setStyle(_this5.contentElementRef.nativeElement, 'transform', "".concat(_this5._translateDir, "(").concat(viewport.padding, "px)"));

                    _this5.renderer.setStyle(_this5.contentElementRef.nativeElement, 'webkitTransform', "".concat(_this5._translateDir, "(").concat(viewport.padding, "px)"));
                  }
                }

                if (_this5.headerElementRef) {
                  var scrollPosition = _this5.getScrollElement()[_this5._scrollType];

                  var containerOffset = _this5.getElementsOffset();

                  var offset = Math.max(scrollPosition - viewport.padding - containerOffset + _this5.headerElementRef.nativeElement.clientHeight, 0);

                  _this5.renderer.setStyle(_this5.headerElementRef.nativeElement, 'transform', "".concat(_this5._translateDir, "(").concat(offset, "px)"));

                  _this5.renderer.setStyle(_this5.headerElementRef.nativeElement, 'webkitTransform', "".concat(_this5._translateDir, "(").concat(offset, "px)"));
                }
                ...
                if (startChanged || endChanged || scrollPositionChanged) {
                  var handleChanged = function handleChanged() {
                    ...
                    _this5.viewPortItems = viewport.startIndexWithBuffer >= 0 && viewport.endIndexWithBuffer >= 0 ? _this5.items.slice(viewport.startIndexWithBuffer, viewport.endIndexWithBuffer + 1) : [];

                    _this5.vsUpdate.emit(_this5.viewPortItems);

                    if (startChanged) {
                      _this5.vsStart.emit(changeEventArg);
                    }

                    if (endChanged) {
                      _this5.vsEnd.emit(changeEventArg);
                    }

                    if (startChanged || endChanged) {
                      _this5.changeDetectorRef.markForCheck();

                      _this5.vsChange.emit(changeEventArg);
                    }

                    if (maxRunTimes > 0) {
                      _this5.refresh_internal(false, refreshCompletedCallback, maxRunTimes - 1);
                  ...
                  if (_this5.executeRefreshOutsideAngularZone) {
                    handleChanged();
                  } else {
                    _this5.zone.run(handleChanged);
                  }
                } else {
          ...
          value: function addScrollEventHandlers() {
            ...
            this.removeScrollEventHandlers();
            this.zone.runOutsideAngular(function () {
              if (_this6.parentScroll instanceof Window) {
                _this6.disposeScrollHandler = _this6.renderer.listen('window', 'scroll', _this6.onScroll);
                _this6.disposeResizeHandler = _this6.renderer.listen('window', 'resize', _this6.onScroll);
              } else {
                _this6.disposeScrollHandler = _this6.renderer.listen(scrollElement, 'scroll', _this6.onScroll);

                if (_this6._checkResizeInterval > 0) {
                  _this6.checkScrollElementResizedTimer = setInterval(function () {
                    _this6.checkScrollElementResized();
                  }, _this6._checkResizeInterval);
                }
              }
            });
          }
      ...
      VirtualScrollerComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/ouedraog/Dev/angular2-multiselect-dropdown/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    function HR(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SearchFilterByOnePropertyExample", function () {
      ...
      var _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/view.html */
      "oq+e");
      /* harmony import */
      ...
      var SearchFilterByOnePropertyExample = /*#__PURE__*/function () {
        function SearchFilterByOnePropertyExample() {
          _classCallCheck(this, SearchFilterByOnePropertyExample);
        ...
        _createClass(SearchFilterByOnePropertyExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      SearchFilterByOnePropertyExample.ctorParameters = function () {
        return [];
      };

      SearchFilterByOnePropertyExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], SearchFilterByOnePropertyExample);
      /***/
    },
    ...
    /***/
    function m23(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SearchFilterAddItemExample", function () {
      ...
      var _raw_loader_views_searchFilter_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/searchFilter.html */
      "cnN+");
      /* harmony import */
      ...
      var SearchFilterAddItemExample = /*#__PURE__*/function () {
        function SearchFilterAddItemExample() {
          _classCallCheck(this, SearchFilterAddItemExample);
        ...
        _createClass(SearchFilterAddItemExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      SearchFilterAddItemExample.ctorParameters = function () {
        return [];
      };

      SearchFilterAddItemExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_searchFilter_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], SearchFilterAddItemExample);
      /***/
    },
    ...
    function G8H(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "UsingInListExample", function () {
      ...
      var _raw_loader_views_usingInList_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/usingInList.html */
      "zEep");
      /* harmony import */
      ...
      var UsingInListExample = /*#__PURE__*/function () {
        function UsingInListExample() {
          _classCallCheck(this, UsingInListExample);
        ...
        _createClass(UsingInListExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.customers = [{
              name: "Toshiba",
          ...
          key: "onGroupSelect",
          value: function onGroupSelect(selectedGroupItem) {
            console.log(selectedGroupItem);
          }
        }, {
          key: "onGroupDeSelect",
          value: function onGroupDeSelect(deselectedGroupItem) {
      ...
      UsingInListExample.ctorParameters = function () {
        return [];
      };

      UsingInListExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_usingInList_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], UsingInListExample);
      /***/
    },
    ...
    /***/
    function KOa(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function YH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LimitSelectionExample", function () {
      ...
      var LimitSelectionExample = /*#__PURE__*/function () {
        function LimitSelectionExample() {
          _classCallCheck(this, LimitSelectionExample);
        ...
        _createClass(LimitSelectionExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      LimitSelectionExample.ctorParameters = function () {
        return [];
      };

      LimitSelectionExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], LimitSelectionExample);
      /***/
    },
    ...
    /***/
    function A0o3(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function AI6X(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UsingWithReactiveFormExample", function () {
      ...
      var _raw_loader_views_using_in_react_form_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/using-in-react-form.html */
      "rRTn");
      /* harmony import */
      ...
      var UsingWithReactiveFormExample = /*#__PURE__*/function () {
        function UsingWithReactiveFormExample(fb) {
          _classCallCheck(this, UsingWithReactiveFormExample);
        ...
        _createClass(UsingWithReactiveFormExample, [{
          key: "createForm",
      ...
      UsingWithReactiveFormExample.ctorParameters = function () {
        return [{
          type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]
        }];
      };

      UsingWithReactiveFormExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_using_in_react_form_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])], UsingWithReactiveFormExample);
      /***/
    },
    ...
    /***/
    function Cc3u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SingleSelectionExample", function () {
      ...
      var _raw_loader_views_singleSelection_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/singleSelection.html */
      "mqXn");
      /* harmony import */
      ...
      var SingleSelectionExample = /*#__PURE__*/function () {
        function SingleSelectionExample() {
          _classCallCheck(this, SingleSelectionExample);
        ...
        _createClass(SingleSelectionExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      SingleSelectionExample.ctorParameters = function () {
        return [];
      };

      SingleSelectionExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_singleSelection_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], SingleSelectionExample);
      /***/
    },
    ...
    /***/
    function Dp6d(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ThemingExample", function () {
      ...
      var _raw_loader_views_theming_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/theming.html */
      "A0o3");
      /* harmony import */
      ...
      var ThemingExample = /*#__PURE__*/function () {
        function ThemingExample() {
          _classCallCheck(this, ThemingExample);
      ...
      ThemingExample.ctorParameters = function () {
        return [];
      };

      ThemingExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_theming_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ThemingExample);
      /***/
    },
    ...
    /***/
    function EV4R(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BasicExample", function () {
        return BasicExample;
      });
      /* harmony import */
      ...
      var BasicExample = /*#__PURE__*/function () {
      ...
      BasicExample.ctorParameters = function () {
        return [{
      ...
      BasicExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Title"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Meta"]])], BasicExample);
      /***/
    },
    ...
    /***/
    function Es2b(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FAL1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomPlaceholderExample", function () {
      ...
      var CustomPlaceholderExample = /*#__PURE__*/function () {
        function CustomPlaceholderExample() {
          _classCallCheck(this, CustomPlaceholderExample);
        ...
        _createClass(CustomPlaceholderExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      CustomPlaceholderExample.ctorParameters = function () {
        return [];
      };

      CustomPlaceholderExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], CustomPlaceholderExample);
      /***/
    },
    ...
    /***/
    function FhU7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DisableModeExample", function () {
      ...
      var _raw_loader_views_disableMode_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/disableMode.html */
      "pAi7");
      /* harmony import */
      ...
      var DisableModeExample = /*#__PURE__*/function () {
        function DisableModeExample() {
          _classCallCheck(this, DisableModeExample);
        ...
        _createClass(DisableModeExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      DisableModeExample.ctorParameters = function () {
        return [];
      };

      DisableModeExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_disableMode_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], DisableModeExample);
      /***/
    },
    ...
    /***/
    function GiCq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SearchFilterExample", function () {
      ...
      var SearchFilterExample = /*#__PURE__*/function () {
        function SearchFilterExample() {
          _classCallCheck(this, SearchFilterExample);
        ...
        _createClass(SearchFilterExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      SearchFilterExample.ctorParameters = function () {
        return [];
      };

      SearchFilterExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], SearchFilterExample);
      /***/
    },
    ...
    /***/
    function HQso(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function IUYE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], ClickOutsideDirective);
      ...
      ScrollDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
        selector: '[scroll]'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], ScrollDirective);
      ...
      styleDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
        selector: '[styleProp]'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], styleDirective);
      ...
      setPosition = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
        selector: '[setPosition]'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], setPosition);
      /***/
    },
    ...
    /***/
    function IYYJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SourceTab", function () {
        return SourceTab;
      });
      /* harmony import */
      ...
      var _raw_loader_sourcetab_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./sourcetab.component.html */
      "451l");
      /* harmony import */


      var _sourcetab_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./sourcetab.component.css */
      "MgUT");
      /* harmony import */
      ...
      var SourceTab = /*#__PURE__*/function () {
        function SourceTab() {
          _classCallCheck(this, SourceTab);
        }

        _createClass(SourceTab, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      SourceTab.ctorParameters = function () {
        return [];
      };
      ...
      SourceTab = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], SourceTab);
      /***/
    },
    ...
    /***/
    function IjA9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MgUT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MkSg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CIcon", function () {
        return CIcon;
      });
      /* harmony import */
      ...
      Item = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'c-item',
        template: ""
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], Item);
      ...
      Badge = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'c-badge',
        template: ""
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], Badge);
      ...
      Search = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'c-search',
        template: ""
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], Search);
      ...
      TemplateRenderer = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'c-templateRenderer',
        template: ""
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"]])], TemplateRenderer);
      ...
      CIcon = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'c-icon',
    ...
    /***/
    function MzOt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LazyLoadingRemoteDataExample", function () {
      ...
      var _raw_loader_views_lazyLoadingRemoteData_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/lazyLoadingRemoteData.html */
      "h+7P");
      /* harmony import */
      ...
      var LazyLoadingRemoteDataExample = /*#__PURE__*/function () {
        function LazyLoadingRemoteDataExample(appService) {
          _classCallCheck(this, LazyLoadingRemoteDataExample);
        ...
        _createClass(LazyLoadingRemoteDataExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [];
            this.selectedItems = [];
          ...
          key: "fetchMore",
          value: function fetchMore(event) {
            var _this7 = this;
            ...
            if (event.endIndex === this.itemList.length - 1) {
              ...
              this.appService.getChunkData(this.itemList.length, this.bufferSize).then(function (chunk) {
                _this7.itemList = _this7.itemList.concat(chunk);
      ...
      LazyLoadingRemoteDataExample.ctorParameters = function () {
        return [{
          type: _mock_data__WEBPACK_IMPORTED_MODULE_3__["MockService"]
        }];
      };

      LazyLoadingRemoteDataExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_lazyLoadingRemoteData_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_mock_data__WEBPACK_IMPORTED_MODULE_3__["MockService"]])], LazyLoadingRemoteDataExample);
      /***/
    },
    ...
    /***/
    function Nj87(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TemplatingExample", function () {
      ...
      var _raw_loader_views_templating_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/templating.html */
      "wJUg");
      /* harmony import */
      ...
      var TemplatingExample = /*#__PURE__*/function () {
        function TemplatingExample() {
          _classCallCheck(this, TemplatingExample);
        ...
        _createClass(TemplatingExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "category": "asia",
      ...
      TemplatingExample.ctorParameters = function () {
        return [];
      };

      TemplatingExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_templating_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], TemplatingExample);
      /***/
    },
    ...
    /***/
    function OTWy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function OTsr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DynamicDataSetsExample", function () {
      ...
      var _raw_loader_views_dynamicData_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/dynamicData.html */
      "tQxY");
      /* harmony import */
      ...
      var DynamicDataSetsExample = /*#__PURE__*/function () {
        function DynamicDataSetsExample(mockService) {
          _classCallCheck(this, DynamicDataSetsExample);
        ...
        _createClass(DynamicDataSetsExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.settings = {
              text: "Select Countries",
      ...
      DynamicDataSetsExample.ctorParameters = function () {
        return [{
          type: _mock_data__WEBPACK_IMPORTED_MODULE_3__["MockService"]
        }];
      };

      DynamicDataSetsExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_dynamicData_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_mock_data__WEBPACK_IMPORTED_MODULE_3__["MockService"]])], DynamicDataSetsExample);
      /***/
    },
    ...
    /***/
    function OtF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _multiselect_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./multiselect.service */
      "/Bsz");
        ...
        _createClass(ListFilterPipe, [{
          ...
          value: function transform(items, filter, searchBy) {
            ...
            this.filteredList = items.filter(function (item) {
              return _this8.applyFilter(item, filter, searchBy);
            });
      ...
      ListFilterPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'listFilter',
        pure: true
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_multiselect_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]])], ListFilterPipe);
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _check_for_update_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./check-for-update.service */
      "kW9T");

      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(updates, checkForUpdateService) {
          var _this9 = this;
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_service_worker__WEBPACK_IMPORTED_MODULE_4__["SwUpdate"], _check_for_update_service__WEBPACK_IMPORTED_MODULE_5__["CheckForUpdateService"]])], AppComponent);
      /***/
    },
    ...
    /***/
    function TNf0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function W8cJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "GroupByExample", function () {
      ...
      var _raw_loader_views_groupBy_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/groupBy.html */
      "Y0Q9");
      /* harmony import */
      ...
      var GroupByExample = /*#__PURE__*/function () {
        function GroupByExample() {
          _classCallCheck(this, GroupByExample);
      ...
      GroupByExample.ctorParameters = function () {
        return [];
      };

      GroupByExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_groupBy_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], GroupByExample);
      /***/
    },
    ...
    /***/
    function XYH9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Y0Q9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _examples_mock_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./examples/mock-data */
      "d2kl");
      /* harmony import */
      ...
      var _projects_angular2_multiselect_dropdown_lib_src_lib_multiselect_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../projects/angular2-multiselect-dropdown-lib/src/lib/multiselect.component */
      "rhI+");
      /* harmony import */


      var _app_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./app.router */
      "qb35");
      /* harmony import */


      var _examples_basic__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./examples/basic */
      "EV4R");
      /* harmony import */


      var _examples_singleselection__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./examples/singleselection */
      "Cc3u");
      /* harmony import */


      var _examples_groupBy__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./examples/groupBy */
      "W8cJ");
      /* harmony import */


      var _examples_searchFilter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./examples/searchFilter */
      "GiCq");
      /* harmony import */


      var _examples_templating__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./examples/templating */
      "Nj87");
      /* harmony import */


      var _examples_resetdropdown__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./examples/resetdropdown */
      "q+g8");
      /* harmony import */


      var _examples_disablemode__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./examples/disablemode */
      "FhU7");
      /* harmony import */


      var _examples_limitselection__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./examples/limitselection */
      "97YH");
      /* harmony import */


      var _examples_limitbadges__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./examples/limitbadges */
      "iKEM");
      /* harmony import */


      var _examples_customplaceholder__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./examples/customplaceholder */
      "FAL1");
      /* harmony import */


      var _examples_styling__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./examples/styling */
      "nQ5r");
      /* harmony import */


      var _examples_gist__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./examples/gist */
      "n/B8");
      /* harmony import */


      var _examples_usingWithForms__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./examples/usingWithForms */
      "qPdk");
      /* harmony import */


      var _examples_usingInReactForms__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ./examples/usingInReactForms */
      "AI6X");
      /* harmony import */


      var _examples_lazyLoading__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ./examples/lazyLoading */
      "xsbp");
      /* harmony import */


      var _examples_multipleDropdowns__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ./examples/multipleDropdowns */
      "ykQj");
      /* harmony import */


      var _examples_dynamicDataSets__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! ./examples/dynamicDataSets */
      "OTsr");
      /* harmony import */


      var _examples_theming__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
      /*! ./examples/theming */
      "Dp6d");
      /* harmony import */


      var _examples_remoteData__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
      /*! ./examples/remoteData */
      "sx+6");
      /* harmony import */


      var _examples_customSearch__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
      /*! ./examples/customSearch */
      "ul0k");
      /* harmony import */


      var _examples_searchByOneProperty__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
      /*! ./examples/searchByOneProperty */
      "03HR");
      /* harmony import */


      var _examples_lazyLoadingRemoteData__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
      /*! ./examples/lazyLoadingRemoteData */
      "MzOt");
      /* harmony import */


      var _examples_searchFilterAddNewItem__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
      /*! ./examples/searchFilterAddNewItem */
      "1m23");
      /* harmony import */


      var _examples_events__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
      /*! ./examples/events */
      "g8Lg");
      /* harmony import */


      var ngx_highlightjs__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
      /*! ngx-highlightjs */
      "OtPg");
      /* harmony import */


      var _examples_usingInList__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
      /*! ./examples/usingInList */
      "3G8H");
      /* harmony import */


      var _components_sourcetab_sourcetab_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
      /*! ./components/sourcetab/sourcetab.component */
      "IYYJ");
      /* harmony import */


      var highlight_js_lib_languages_xml__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
      /*! highlight.js/lib/languages/xml */
      "jctj");
      /* harmony import */


      var highlight_js_lib_languages_xml__WEBPACK_IMPORTED_MODULE_37___default = /*#__PURE__*/__webpack_require__.n(highlight_js_lib_languages_xml__WEBPACK_IMPORTED_MODULE_37__);
      /* harmony import */


      var highlight_js_lib_languages_scss__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
      /*! highlight.js/lib/languages/scss */
      "YROV");
      /* harmony import */


      var highlight_js_lib_languages_scss__WEBPACK_IMPORTED_MODULE_38___default = /*#__PURE__*/__webpack_require__.n(highlight_js_lib_languages_scss__WEBPACK_IMPORTED_MODULE_38__);
      /* harmony import */


      var highlight_js_lib_languages_typescript__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
      /*! highlight.js/lib/languages/typescript */
      "r0Rl");
      /* harmony import */


      var highlight_js_lib_languages_typescript__WEBPACK_IMPORTED_MODULE_39___default = /*#__PURE__*/__webpack_require__.n(highlight_js_lib_languages_typescript__WEBPACK_IMPORTED_MODULE_39__);
      /* harmony import */
      ...
      var _check_for_update_service__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
      /*! ./check-for-update.service */
      "kW9T");
      /* harmony import */
      ...
      function hljsLanguages() {
        return [{
          name: 'typescript',
          func: highlight_js_lib_languages_typescript__WEBPACK_IMPORTED_MODULE_39___default.a
        }, {
          name: 'scss',
          func: highlight_js_lib_languages_scss__WEBPACK_IMPORTED_MODULE_38___default.a
        }, {
          name: 'xml',
          func: highlight_js_lib_languages_xml__WEBPACK_IMPORTED_MODULE_37___default.a
        }];
      }
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _examples_gist__WEBPACK_IMPORTED_MODULE_21__["ng2Gist"], _examples_basic__WEBPACK_IMPORTED_MODULE_10__["BasicExample"], _examples_singleselection__WEBPACK_IMPORTED_MODULE_11__["SingleSelectionExample"], _examples_groupBy__WEBPACK_IMPORTED_MODULE_12__["GroupByExample"], _examples_searchFilter__WEBPACK_IMPORTED_MODULE_13__["SearchFilterExample"], _examples_templating__WEBPACK_IMPORTED_MODULE_14__["TemplatingExample"], _examples_resetdropdown__WEBPACK_IMPORTED_MODULE_15__["ResetDropdownExample"], _examples_disablemode__WEBPACK_IMPORTED_MODULE_16__["DisableModeExample"], _examples_limitselection__WEBPACK_IMPORTED_MODULE_17__["LimitSelectionExample"], _examples_limitbadges__WEBPACK_IMPORTED_MODULE_18__["LimitBadgesExample"], _examples_customplaceholder__WEBPACK_IMPORTED_MODULE_19__["CustomPlaceholderExample"], _examples_styling__WEBPACK_IMPORTED_MODULE_20__["StylingExample"], _examples_usingWithForms__WEBPACK_IMPORTED_MODULE_22__["UsingWithFormExample"], _examples_usingInReactForms__WEBPACK_IMPORTED_MODULE_23__["UsingWithReactiveFormExample"], _examples_lazyLoading__WEBPACK_IMPORTED_MODULE_24__["LazyLoadingExample"], _examples_multipleDropdowns__WEBPACK_IMPORTED_MODULE_25__["MultipleDropdownsExample"], _examples_dynamicDataSets__WEBPACK_IMPORTED_MODULE_26__["DynamicDataSetsExample"], _examples_theming__WEBPACK_IMPORTED_MODULE_27__["ThemingExample"], _examples_remoteData__WEBPACK_IMPORTED_MODULE_28__["RemoteDataExample"], _examples_customSearch__WEBPACK_IMPORTED_MODULE_29__["CustomSearchExample"], _examples_searchByOneProperty__WEBPACK_IMPORTED_MODULE_30__["SearchFilterByOnePropertyExample"], _examples_lazyLoadingRemoteData__WEBPACK_IMPORTED_MODULE_31__["LazyLoadingRemoteDataExample"], _examples_searchFilterAddNewItem__WEBPACK_IMPORTED_MODULE_32__["SearchFilterAddItemExample"], _examples_events__WEBPACK_IMPORTED_MODULE_33__["EventsExample"], _examples_usingInList__WEBPACK_IMPORTED_MODULE_35__["UsingInListExample"], _components_sourcetab_sourcetab_component__WEBPACK_IMPORTED_MODULE_36__["SourceTab"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"].withServerTransition({
          appId: 'serverApp'
        }), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _app_router__WEBPACK_IMPORTED_MODULE_9__["AppRouterModule"], _projects_angular2_multiselect_dropdown_lib_src_lib_multiselect_component__WEBPACK_IMPORTED_MODULE_8__["AngularMultiSelectModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_6__["MatTabsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_44__["MatButtonModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_45__["MatProgressSpinnerModule"], ngx_highlightjs__WEBPACK_IMPORTED_MODULE_34__["HighlightModule"].forRoot({
          languages: hljsLanguages
        }), _angular_service_worker__WEBPACK_IMPORTED_MODULE_40__["ServiceWorkerModule"].register('ngsw-worker.js', {
    ...
    /***/
    function d2kl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var MockService = /*#__PURE__*/function () {
        ...
        _createClass(MockService, [{
          ...
          key: "getChunkData",
          value: function getChunkData(skip, limit) {
            var _this11 = this;

            return new Promise(function (resolve, reject) {
              clearTimeout(_this11.timer);
              _this11.timer = setTimeout(function () {
                if (skip < _this11.itemList.length) {
                  return resolve(_this11.itemList.slice(skip, skip + limit));
                }
      ...
      MockService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], MockService);
      /***/
    },
    ...
    /***/
    function g8Lg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EventsExample", function () {
      ...
      var _raw_loader_views_events_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/events.html */
      "OTWy");
      /* harmony import */
      ...
      var EventsExample = /*#__PURE__*/function () {
      ...
      EventsExample.ctorParameters = function () {
        return [];
      };

      EventsExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_events_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], EventsExample);
      /***/
    },
    ...
    /***/
    function h7P(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function iKEM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LimitBadgesExample", function () {
      ...
      var LimitBadgesExample = /*#__PURE__*/function () {
        function LimitBadgesExample() {
          _classCallCheck(this, LimitBadgesExample);
        ...
        _createClass(LimitBadgesExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      LimitBadgesExample.ctorParameters = function () {
        return [];
      };

      LimitBadgesExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], LimitBadgesExample);
      /***/
    },
    ...
    /***/
    function kW9T(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CheckForUpdateService", function () {
      ...
      var CheckForUpdateService = function CheckForUpdateService(appRef, updates) {
        _classCallCheck(this, CheckForUpdateService);

        // Allow the app to stabilize first, before starting polling for updates with `interval()`.
        var appIsStable$ = appRef.isStable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])(function (isStable) {
          return isStable === true;
        }));
        var everySixHours$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(24 * 60 * 60 * 1000);
        var everySixHoursOnceAppIsStable$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["concat"])(appIsStable$, everySixHours$);
        everySixHoursOnceAppIsStable$.subscribe(function () {
          console.log("checking for update");
          updates.checkForUpdate();
        });
      };

      CheckForUpdateService.ctorParameters = function () {
        return [{
      ...
      CheckForUpdateService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ApplicationRef"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_2__["SwUpdate"]])], CheckForUpdateService);
      /***/
    },
    ...
    /***/
    function mqXn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function nB8(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ng2Gist", function () {
        return ng2Gist;
      });
      /* harmony import */
      ...
      var ng2Gist = /*#__PURE__*/function () {
        function ng2Gist() {
          _classCallCheck(this, ng2Gist);
        }

        _createClass(ng2Gist, [{
          key: "ngAfterViewInit",
      ...
      ng2Gist.ctorParameters = function () {
        return [];
      };
      ...
      ng2Gist = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'ng2-gist',
        template: "\n    <iframe #iframe type=\"text/javascript\" width=\"100%\" frameborder=\"0\"></iframe>\n  "
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ng2Gist);
      /***/
    },
    ...
    /***/
    function nQ5r(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StylingExample", function () {
      ...
      var StylingExample = /*#__PURE__*/function () {
        function StylingExample() {
          _classCallCheck(this, StylingExample);
      ...
      StylingExample.ctorParameters = function () {
        return [];
      };

      StylingExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_view_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], StylingExample);
      /***/
    },
    ...
    /***/
    function oqE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function pAi7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function qG8(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ResetDropdownExample", function () {
      ...
      var _raw_loader_views_resetDropdown_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/resetDropdown.html */
      "Es2b");
      /* harmony import */
      ...
      var _projects_angular2_multiselect_dropdown_lib_src_lib_multiselect_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../../projects/angular2-multiselect-dropdown-lib/src/lib/multiselect.component */
      "rhI+");

      var ResetDropdownExample = /*#__PURE__*/function () {
        function ResetDropdownExample() {
          _classCallCheck(this, ResetDropdownExample);
        ...
        _createClass(ResetDropdownExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [{
              "id": 1,
      ...
      ResetDropdownExample.ctorParameters = function () {
        return [];
      };
      ...
      ResetDropdownExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_resetDropdown_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ResetDropdownExample);
      /***/
    },
    ...
    /***/
    function qPdk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UsingWithFormExample", function () {
      ...
      var _raw_loader_views_using_in_form_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/using-in-form.html */
      "s2fm");
      /* harmony import */
      ...
      var UsingWithFormExample = /*#__PURE__*/function () {
        function UsingWithFormExample() {
          _classCallCheck(this, UsingWithFormExample);
        ...
        _createClass(UsingWithFormExample, [{
          key: "onSubmit",
      ...
      UsingWithFormExample.ctorParameters = function () {
        return [];
      };

      UsingWithFormExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_using_in_form_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], UsingWithFormExample);
      /***/
    },
    ...
    /***/
    function qb35(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _examples_basic__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./examples/basic */
      "EV4R");
      /* harmony import */


      var _examples_singleselection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./examples/singleselection */
      "Cc3u");
      /* harmony import */


      var _examples_groupBy__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./examples/groupBy */
      "W8cJ");
      /* harmony import */


      var _examples_searchFilter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./examples/searchFilter */
      "GiCq");
      /* harmony import */


      var _examples_templating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./examples/templating */
      "Nj87");
      /* harmony import */


      var _examples_resetdropdown__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./examples/resetdropdown */
      "q+g8");
      /* harmony import */


      var _examples_disablemode__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./examples/disablemode */
      "FhU7");
      /* harmony import */


      var _examples_limitselection__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./examples/limitselection */
      "97YH");
      /* harmony import */


      var _examples_limitbadges__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./examples/limitbadges */
      "iKEM");
      /* harmony import */


      var _examples_customplaceholder__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./examples/customplaceholder */
      "FAL1");
      /* harmony import */


      var _examples_styling__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./examples/styling */
      "nQ5r");
      /* harmony import */


      var _examples_usingWithForms__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./examples/usingWithForms */
      "qPdk");
      /* harmony import */


      var _examples_usingInReactForms__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./examples/usingInReactForms */
      "AI6X");
      /* harmony import */


      var _examples_lazyLoading__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./examples/lazyLoading */
      "xsbp");
      /* harmony import */


      var _examples_multipleDropdowns__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./examples/multipleDropdowns */
      "ykQj");
      /* harmony import */


      var _examples_dynamicDataSets__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./examples/dynamicDataSets */
      "OTsr");
      /* harmony import */


      var _examples_theming__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./examples/theming */
      "Dp6d");
      /* harmony import */


      var _examples_remoteData__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./examples/remoteData */
      "sx+6");
      /* harmony import */


      var _examples_customSearch__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./examples/customSearch */
      "ul0k");
      /* harmony import */


      var _examples_searchByOneProperty__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./examples/searchByOneProperty */
      "03HR");
      /* harmony import */


      var _examples_lazyLoadingRemoteData__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ./examples/lazyLoadingRemoteData */
      "MzOt");
      /* harmony import */


      var _examples_searchFilterAddNewItem__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ./examples/searchFilterAddNewItem */
      "1m23");
      /* harmony import */


      var _examples_events__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ./examples/events */
      "g8Lg");
      /* harmony import */


      var _examples_usingInList__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! ./examples/usingInList */
      "3G8H");
      ...
      var appRoutes = [{
        ...
        path: 'basic',
        component: _examples_basic__WEBPACK_IMPORTED_MODULE_3__["BasicExample"]
      }, {
        path: 'singleselection',
        component: _examples_singleselection__WEBPACK_IMPORTED_MODULE_4__["SingleSelectionExample"]
      }, {
        path: 'searchfilter',
        component: _examples_searchFilter__WEBPACK_IMPORTED_MODULE_6__["SearchFilterExample"]
      }, {
        path: 'groupby',
        component: _examples_groupBy__WEBPACK_IMPORTED_MODULE_5__["GroupByExample"]
      }, {
        path: 'templating',
        component: _examples_templating__WEBPACK_IMPORTED_MODULE_7__["TemplatingExample"]
      }, {
        path: 'dropdownMethods',
        component: _examples_resetdropdown__WEBPACK_IMPORTED_MODULE_8__["ResetDropdownExample"]
      }, {
        path: 'disablemode',
        component: _examples_disablemode__WEBPACK_IMPORTED_MODULE_9__["DisableModeExample"]
      }, {
        path: 'limitselection',
        component: _examples_limitselection__WEBPACK_IMPORTED_MODULE_10__["LimitSelectionExample"]
      }, {
        path: 'limitbadges',
        component: _examples_limitbadges__WEBPACK_IMPORTED_MODULE_11__["LimitBadgesExample"]
      }, {
        path: 'customplaceholder',
        component: _examples_customplaceholder__WEBPACK_IMPORTED_MODULE_12__["CustomPlaceholderExample"]
      }, {
        path: 'styling',
        component: _examples_styling__WEBPACK_IMPORTED_MODULE_13__["StylingExample"]
      }, {
        path: 'usinginform',
        component: _examples_usingWithForms__WEBPACK_IMPORTED_MODULE_14__["UsingWithFormExample"]
      }, {
        path: 'usinginreactiveform',
        component: _examples_usingInReactForms__WEBPACK_IMPORTED_MODULE_15__["UsingWithReactiveFormExample"]
      }, {
        path: 'lazyloading',
        component: _examples_lazyLoading__WEBPACK_IMPORTED_MODULE_16__["LazyLoadingExample"]
      }, {
        path: 'multipledropdowns',
        component: _examples_multipleDropdowns__WEBPACK_IMPORTED_MODULE_17__["MultipleDropdownsExample"]
      }, {
        path: 'dynamicdatasets',
        component: _examples_dynamicDataSets__WEBPACK_IMPORTED_MODULE_18__["DynamicDataSetsExample"]
      }, {
        path: 'theming',
        component: _examples_theming__WEBPACK_IMPORTED_MODULE_19__["ThemingExample"]
      }, {
        path: 'remoteData',
        component: _examples_remoteData__WEBPACK_IMPORTED_MODULE_20__["RemoteDataExample"]
      }, {
        path: 'customSearchAPI',
        component: _examples_customSearch__WEBPACK_IMPORTED_MODULE_21__["CustomSearchExample"]
      }, {
        path: 'searchFilterByOneProperty',
        component: _examples_searchByOneProperty__WEBPACK_IMPORTED_MODULE_22__["SearchFilterByOnePropertyExample"]
      }, {
        path: 'lazyloadingRemoteData',
        component: _examples_lazyLoadingRemoteData__WEBPACK_IMPORTED_MODULE_23__["LazyLoadingRemoteDataExample"]
      }, {
        path: 'searchfilterAddNewItem',
        component: _examples_searchFilterAddNewItem__WEBPACK_IMPORTED_MODULE_24__["SearchFilterAddItemExample"]
      }, {
        path: 'events',
        component: _examples_events__WEBPACK_IMPORTED_MODULE_25__["EventsExample"]
      }, {
        path: 'usingInList',
        component: _examples_usingInList__WEBPACK_IMPORTED_MODULE_26__["UsingInListExample"]
      }];
      ...
      AppRouterModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function rRTn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function rhI(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "DROPDOWN_CONTROL_VALUE_ACCESSOR", function () {
        return DROPDOWN_CONTROL_VALUE_ACCESSOR;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "DROPDOWN_CONTROL_VALIDATION", function () {
      ...
      var _raw_loader_multiselect_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./multiselect.component.html */
      "IjA9");
      /* harmony import */


      var _multiselect_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _multiselect_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./multiselect.model */
      "wjTE");
      /* harmony import */


      var _clickOutside__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./clickOutside */
      "IUYE");
      /* harmony import */


      var _list_filter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./list-filter */
      "OtF+");
      /* harmony import */


      var _menu_item__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./menu-item */
      "MkSg");
      /* harmony import */


      var _multiselect_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./multiselect.service */
      "/Bsz");
      /* harmony import */
      ...
      var _virtual_scroll_virtual_scroll__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var AngularMultiSelect = /*#__PURE__*/function () {
        function AngularMultiSelect(_elementRef, cdr, ds) {
          ...
          this.searchTerm$.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["debounceTime"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["tap"])(function (term) {
            return term;
          })).subscribe(function (val) {
            _this13.filterInfiniteList(val);
          });
        }
        ...
        _createClass(AngularMultiSelect, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.settings.position == 'top') {
              setTimeout(function () {
                _this14.selectedListHeight = {
                  val: 0
                };
                _this14.selectedListHeight.val = _this14.selectedListElem.nativeElement.clientHeight;
              });
            }
            ...
            this.subscription = this.ds.getData().subscribe(function (data) {
              if (data) {
                ...
                data.forEach(function (obj, i) {
                  if (obj.disabled) {
                    _this14.isDisabledItemPresent = true;
                  }
                ...
                _this14.filterLength = len;

                _this14.onFilterChange(data);
              }
            });
            setTimeout(function () {
              _this14.calculateDropdownDirection();
            });
            this.virtualScroollInit = false;
          }
        }, {
              ...
              if (this.settings.singleSelection) {
                if (this.settings.groupBy) {
                  ...
                  try {
                    if (value.length > 1) {
                      this.selectedItems = [value[0]];
                      throw new _multiselect_model__WEBPACK_IMPORTED_MODULE_6__["MyException"](404, {
          ...
          value: function isSelected(clickedItem) {
            ...
            this.selectedItems && this.selectedItems.forEach(function (item) {
              if (clickedItem[_this15.settings.primaryKey] === item[_this15.settings.primaryKey]) {
                found = true;
              }
            });
            return found;
          ...
          value: function removeSelected(clickedItem) {
            ...
            this.selectedItems && this.selectedItems.forEach(function (item) {
              if (clickedItem[_this16.settings.primaryKey] === item[_this16.settings.primaryKey]) {
                _this16.selectedItems.splice(_this16.selectedItems.indexOf(item), 1);
              }
            });
            this.onChangeCallback(this.selectedItems);
            this.onTouchedCallback(this.selectedItems);
          ...
          value: function toggleDropdown(evt) {
            ...
            if (this.isActive) {
              if (this.settings.searchAutofocus && this.searchInput && this.settings.enableSearchFilter && !this.searchTempl) {
                setTimeout(function () {
                  _this17.searchInput.nativeElement.focus();
                }, 0);
              }
          ...
          value: function openDropdown() {
            ...
            if (this.settings.searchAutofocus && this.searchInput && this.settings.enableSearchFilter && !this.searchTempl) {
              setTimeout(function () {
                _this18.searchInput.nativeElement.focus();
              }, 0);
            }
          ...
          value: function toggleSelectAll(event) {
            ...
            setTimeout(function () {
              _this19.calculateDropdownDirection();
            });
          ...
          value: function filterGroupedList() {
            ...
            this.groupedData = this.groupedData.filter(function (obj) {
              ...
              if (obj[_this20.settings.labelKey].toLowerCase().indexOf(_this20.filter.toLowerCase()) > -1) {
                arr = obj.list;
              } else {
                arr = obj.list.filter(function (t) {
                  return t[_this20.settings.labelKey].toLowerCase().indexOf(_this20.filter.toLowerCase()) > -1;
                });
              }
              ...
              if (obj[_this20.settings.labelKey].toLowerCase().indexOf(_this20.filter.toLowerCase()) > -1) {
                ...
                return arr.some(function (cat) {
                  return cat[_this20.settings.labelKey].toLowerCase().indexOf(_this20.filter.toLowerCase()) > -1;
                });
              }
            });
          }
            ...
            if (!this.isFilterSelectAll) {
              ...
              if (this.settings.groupBy) {
                ...
                this.ds.getFilteredData().forEach(function (el) {
                  if (!_this21.isSelected(el) && !el.hasOwnProperty('grpTitle')) {
                    _this21.addSelected(el);
                ...
                this.ds.getFilteredData().forEach(function (item) {
                  if (!_this21.isSelected(item)) {
                    _this21.addSelected(item);
              ...
              if (this.settings.groupBy) {
                ...
                this.ds.getFilteredData().forEach(function (el) {
                  if (_this21.isSelected(el)) {
                    _this21.removeSelected(el);
          ...
          value: function toggleInfiniteFilterSelectAll() {
            ...
            if (!this.isInfiniteFilterSelectAll) {
              this.virtualdata.forEach(function (item) {
                if (!_this22.isSelected(item)) {
                  _this22.addSelected(item);
                }
              });
          ...
          value: function onFilterChange(data) {
            ...
            data.forEach(function (item) {
              if (!item.hasOwnProperty('grpTitle') && _this23.isSelected(item)) {
                cnt++;
              }
            });
          ...
          value: function transformData(arr, field) {
            ...
            Object.keys(groupedObj).map(function (x) {
              ...
              obj["grpTitle"] = true;
              obj[_this25.settings.labelKey] = x;
              obj[_this25.settings.groupBy] = x;
              obj['selected'] = false;
              obj['list'] = [];
              var cnt = 0;
              groupedObj[x].forEach(function (item) {
                ...
                if (item.disabled) {
                  _this25.isDisabledItemPresent = true;
                  disabledChildrens.push(item);
                }

                obj.list.push(item);

                if (_this25.isSelected(item)) {
                  cnt++;
                }
              });
            ...
            if ((evt != null || evt != '') && !this.settings.groupBy) {
              if (this.settings.searchBy.length > 0) {
                var _loop = function _loop(t) {
                  _this26.virtualdata.filter(function (el) {
                    if (el[_this26.settings.searchBy[t].toString()].toString().toLowerCase().indexOf(evt.toString().toLowerCase()) >= 0) {
          ...
          value: function selectGroup(item) {
            ...
            if (item.selected) {
              ...
              item.selected = true;
              item.list.forEach(function (obj) {
                if (!_this27.isSelected(obj)) {
                  _this27.addSelected(obj);
                }
              });
      ...
      AngularMultiSelect.propDecorators = {
        ...
        itemTempl: [{
          ...
          args: [_menu_item__WEBPACK_IMPORTED_MODULE_9__["Item"], {
            "static": false
          }]
        }],
        badgeTempl: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ContentChild"],
          args: [_menu_item__WEBPACK_IMPORTED_MODULE_9__["Badge"], {
            "static": false
          }]
        }],
        searchTempl: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ContentChild"],
          args: [_menu_item__WEBPACK_IMPORTED_MODULE_9__["Search"], {
            "static": false
          }]
        }],
        searchInput: [{
        ...
        virtualScroller: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
          args: [_virtual_scroll_virtual_scroll__WEBPACK_IMPORTED_MODULE_12__["VirtualScrollerComponent"], {
            "static": false
          }]
        }]
      };
      AngularMultiSelect = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"], _multiselect_service__WEBPACK_IMPORTED_MODULE_10__["DataService"]])], AngularMultiSelect);

      var AngularMultiSelectModule = function AngularMultiSelectModule() {
        _classCallCheck(this, AngularMultiSelectModule);
      };

      AngularMultiSelectModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
    ...
    /***/
    function s2fm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function sx6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RemoteDataExample", function () {
      ...
      var _raw_loader_views_remoteData_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/remoteData.html */
      "3KOa");
      /* harmony import */
      ...
      var RemoteDataExample = /*#__PURE__*/function () {
        function RemoteDataExample(http) {
          _classCallCheck(this, RemoteDataExample);
        ...
        _createClass(RemoteDataExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this28 = this;

            this.http.get('https://restcountries.eu/rest/v2/all').subscribe(function (res) {
              console.log(res);
              _this28.itemList = res;
            }, function (error) {});
            this.settings = {
              text: "Select Countries",
              selectAllText: 'Select All',
      ...
      RemoteDataExample.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]
        }];
      };

      RemoteDataExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_remoteData_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], RemoteDataExample);
      /***/
    },
    ...
    /***/
    function tQxY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ul0k(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomSearchExample", function () {
      ...
      var _raw_loader_views_customSearch_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/customSearch.html */
      "HQso");
      /* harmony import */
      ...
      var CustomSearchExample = /*#__PURE__*/function () {
        function CustomSearchExample(http) {
          _classCallCheck(this, CustomSearchExample);
        ...
        _createClass(CustomSearchExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.settings = {
              text: "Select Countries",
          ...
          value: function onSearch(evt) {
            ...
            console.log(evt.target.value);
            this.itemList = [];
            this.http.get('https://restcountries.eu/rest/v2/name/' + evt.target.value + '?fulltext=true').subscribe(function (res) {
              console.log(res);
              _this29.itemList = res;
            }, function (error) {});
          }
        }]);
      ...
      CustomSearchExample.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]
        }];
      };

      CustomSearchExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_customSearch_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], CustomSearchExample);
      /***/
    },
    ...
    /***/
    function v5VT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function wJUg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function wjTE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MyException", function () {
        return MyException;
      });
    ...
    /***/
    function xsbp(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LazyLoadingExample", function () {
      ...
      var _raw_loader_views_lazyLoading_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/lazyLoading.html */
      "v5VT");
      /* harmony import */
      ...
      var LazyLoadingExample = /*#__PURE__*/function () {
        function LazyLoadingExample() {
          _classCallCheck(this, LazyLoadingExample);
        ...
        _createClass(LazyLoadingExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.itemList = [];
          ...
          key: "onScrollToEnd",
          value: function onScrollToEnd(e) {
            console.log(e);
          }
        }, {
          key: "changeData",
      ...
      LazyLoadingExample.ctorParameters = function () {
        return [];
      };

      LazyLoadingExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_lazyLoading_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], LazyLoadingExample);
      /***/
    },
    ...
    /***/
    function ykQj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MultipleDropdownsExample", function () {
      ...
      var _raw_loader_views_multipledropdowns_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./views/multipledropdowns.html */
      "XYH9");
      /* harmony import */
      ...
      var MultipleDropdownsExample = /*#__PURE__*/function () {
        function MultipleDropdownsExample(mockService) {
          _classCallCheck(this, MultipleDropdownsExample);
        ...
        _createClass(MultipleDropdownsExample, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.dropdownSettings = {
              text: "Select",
          ...
          key: "onSelectAll2",
          value: function onSelectAll2(items) {
            console.log(items);
          }
        }, {
          key: "onDeSelectAll",
          ...
          key: "onDeSelectAll2",
          value: function onDeSelectAll2(items) {
            console.log(items);
          }
        }, {
          key: "onDirectoriesOpen",
          value: function onDirectoriesOpen(e) {
            this.directoriesDropdownStatus = 'open';
          }
        }, {
          key: "onDirectoriesClose",
          value: function onDirectoriesClose(e) {
            this.directoriesDropdownStatus = 'close';
          }
        }, {
          key: "onCasesOpen",
          value: function onCasesOpen(e) {
            this.casesDropdownStatus = 'open';
          }
        }, {
          key: "onCasesClose",
          value: function onCasesClose(e) {
      ...
      MultipleDropdownsExample.ctorParameters = function () {
        return [{
          type: _mock_data__WEBPACK_IMPORTED_MODULE_3__["MockService"]
        }];
      };

      MultipleDropdownsExample = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_views_multipledropdowns_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_mock_data__WEBPACK_IMPORTED_MODULE_3__["MockService"]])], MultipleDropdownsExample);
      /***/
    },
    ...
    /***/
    function zEep(module, __webpack_exports__, __webpack_require__) {
      "use strict";
